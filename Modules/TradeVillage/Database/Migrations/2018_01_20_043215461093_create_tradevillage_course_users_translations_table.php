...
class CreateTradeVillageCourseUsersTranslationsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('tradevillage__course_users_translations', function (Blueprint $table) {
            ...
            $table->foreign('course_users_id', 'tradevillage__course_users_translations_cu_foreign')->references('id')->on('tradevillage__course_users')->onDelete('cascade');
        });
    }
