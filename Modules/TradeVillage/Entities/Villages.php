...
class Villages extends Model
{
    ...
    protected $fillable = ['category_id', 'image', 'visitor_counter', 'district', 'province','lat','lng', 'active_home'];
    ...
    {
        return $this->hasMany('Modules\\TradeVillage\\Entities\\News', 'village_id');
    }
}
