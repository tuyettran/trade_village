...
@section('content-header')
    <h1>
        {{ trans('tradevillage::edu_course_fields.title.create edu_course_fields') }}
    </h1>
    <ol class="breadcrumb">
        ...
        <li class="active">{{ trans('tradevillage::edu_course_fields.title.create edu_course_fields') }}</li>
    </ol>
@stop

@section('content')
    {!! Form::open(['route' => ['admin.tradevillage.edu_course_fields.store'], 'method' => 'post']) !!}
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="tab-content">
                    ...
                    @foreach (LaravelLocalization::getSupportedLocales() as $locale => $language)
                        ...
                        <div class="tab-pane {{ locale() == $locale ? 'active' : '' }}" id="tab_{{ $i }}">
                            @include('tradevillage::admin.edu_course_fields.partials.create-fields', ['lang' => $locale])
                        </div>
                    @endforeach
