...
@section('content-header')
    <h1>
        {{ trans('tradevillage::artists.title.edit artist') }}
    </h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('dashboard.index') }}"><i class="fa fa-dashboard"></i> {{ trans('core::core.breadcrumb.home') }}</a></li>
        <li><a href="{{ route('admin.tradevillage.artist.index') }}">{{ trans('tradevillage::artists.title.artists') }}</a></li>
        <li class="active">{{ trans('tradevillage::artists.title.edit artist') }}</li>
    </ol>
@stop

@section('content')
    {!! Form::open(['route' => ['admin.tradevillage.artist.update', $artist->id], 'method' => 'put']) !!}
    <div class="row">
        <div class="col-md-12">
