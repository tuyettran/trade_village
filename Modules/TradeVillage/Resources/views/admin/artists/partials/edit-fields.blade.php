<div class="box-body">
    <div class="form-group{{ $errors->has("{$lang}.name") ? " has-error" : "" }}">
	    ...
	    {!! Form::text("{$lang}[name]", old("{$lang}.name", $artist->translate($lang)->name), ["class" => "form-control", "placeholder" => trans("tradevillage::artists.form.name")]) !!}
	...
	<div class="form-group{{ $errors->has("{$lang}.description") ? " has-error" : "" }}">
	    ...
	    {!! Form::text("{$lang}[description]", old("{$lang}.description", $artist->translate($lang)->description), ["class" => "form-control", "placeholder" => trans("tradevillage::artists.form.description")]) !!}
	...
	<div class="form-group{{ $errors->has("{$lang}.address") ? " has-error" : "" }}">
	    ...
	    {!! Form::text("{$lang}[address]", old("{$lang}.address", $artist->translate($lang)->address), ["class" => "form-control", "placeholder" => trans("tradevillage::artists.form.address")]) !!}
