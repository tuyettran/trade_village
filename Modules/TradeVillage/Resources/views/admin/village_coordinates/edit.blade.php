...
@section('content-header')
    <h1>
        {{ trans('tradevillage::village_coordinates.title.edit village_coordinates') }}
    </h1>
    <ol class="breadcrumb">
        ...
        <li class="active">{{ trans('tradevillage::village_coordinates.title.edit village_coordinates') }}</li>
    </ol>
@stop

@section('content')
    {!! Form::open(['route' => ['admin.tradevillage.village_coordinates.update', $village_coordinates->id], 'method' => 'put']) !!}
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="tab-content">
                    ...
                    @foreach (LaravelLocalization::getSupportedLocales() as $locale => $language)
                        ...
                        <div class="tab-pane {{ locale() == $locale ? 'active' : '' }}" id="tab_{{ $i }}">
                            @include('tradevillage::admin.village_coordinates.partials.edit-fields', ['lang' => $locale])
                        </div>
                    @endforeach
