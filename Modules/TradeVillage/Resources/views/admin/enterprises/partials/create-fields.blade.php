<div class="box-body">
    <div class="form-group{{ $errors->has("{$lang}.name") ? " has-error" : "" }}">
        ...
        {!! Form::text("{$lang}[name]", old("{$lang}.name"), ["class" => "form-control", "placeholder" => trans("tradevillage::enterprises.form.name")]) !!}
    ...
    <div class="form-group{{ $errors->has("{$lang}.description") ? " has-error" : "" }}">
        ...
        {!! Form::text("{$lang}[description]", old("{$lang}.description"), ["class" => "form-control", "placeholder" => trans("tradevillage::enterprises.form.description")]) !!}
        
        {!! $errors->first("{$lang}.description", '<span class="help-block">:message</span>') !!}
    </div>

     @editor("detail", trans("tradevillage::enterprises.form.detail"), old("{$lang}.detail"), $lang)
    ...
    <div class="form-group{{ $errors->has("{$lang}.address") ? " has-error" : "" }}">
        ...
        {!! Form::text("{$lang}[address]", old("{$lang}.address"), ["id" => "address", "class" => "form-control", "placeholder" => trans("tradevillage::enterprises.form.address")]) !!}
