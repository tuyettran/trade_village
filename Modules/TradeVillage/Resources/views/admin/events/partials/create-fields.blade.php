<div class="box-body">
    <div class="form-group{{ $errors->has("{$lang}.title") ? " has-error" : "" }}">
	    ...
	    {!! Form::text("{$lang}[title]", old("{$lang}.title"), ["class" => "form-control", "placeholder" => trans("tradevillage::events.form.title")]) !!}
	...
	<div class="form-group{{ $errors->has("{$lang}.address") ? " has-error" : "" }}">
	    ...
	    {!! Form::text("{$lang}[address]", old("{$lang}.address"), ["class" => "form-control", "placeholder" => trans("tradevillage::events.form.address")]) !!}
