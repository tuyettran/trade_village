...
* Extension Date: 2017-09-22
* URL: http://www.ajax-zoom.com
* Documentation: http://www.ajax-zoom.com/index.php?cid=docs
* Example: http://www.ajax-zoom.com/examples/example29.php
*/
			...
			onBeforeStart: function() {
				...
				if ($.isArray(op.galleryData) && op.galleryData.length > 1) {
					...
					if (!op.prevNextAllData.enabled) {
						mNavi.customPos['mCustomBtn'+nextIndex]['class'] = 'axZm_displayNone';
						mNavi.customPos['mCustomBtn'+(nextIndex+1)]['class'] = 'axZm_displayNone';
					}
