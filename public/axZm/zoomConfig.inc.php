...
Ver. 4.3.1+ you can also place / copy you custom parameters from /axZm/zoomConfig.inc.php or /axZm/zoomConfigCustom.inc.php 
into zoomConfigCustomAZ.inc.php which is outside of /axZm directory. This way it is possible to upgrade AJAX-ZOOM by fully overwriting /axZm/ folder.
...
About GD library: when using GD Library you should be abble to set the memory_limit!
...
// Set memory limit for heavy operations like image tiling
$zoom['config']['memory_limit'] = '512M';

// Version number of this config file
$zoom['config']['version'] = '5.0.11';
...
$zoom['config']['pngBackgroundColor'] = '#FFFFFF';
...
// Makes AJAX-ZOOM to switch faster between images
...
// Ver. 4.3.1+ Settings for the vertical gallery, full documentation can be found at http://www.ajax-zoom.com/axZm/extensions/axZmThumbSlider/
...
// Ver. 4.3.1+ Settings for the horizontal gallery, full documentation can be found at http://www.ajax-zoom.com/axZm/extensions/axZmThumbSlider/
...
// Ver. 4.3.1+ Settings for the Inline / Full gallery, full documentation can be found at http://www.ajax-zoom.com/axZm/extensions/axZmThumbSlider/
...
$zoom['config']['spinPreloaderSettings']['text'] = array('en' => 'Loading frames', 'de' => '', 'fr' => '', 'es' => '', 'it' => '', 'pt' => '', 'ru' => '', 'cn'=>'', 'jp' => '');
$zoom['config']['spinPreloaderSettings']['L1'] = array('en' => 'Preloading image', 'de' => '', 'fr' => '', 'es' => '', 'it' => '', 'pt' => '', 'ru' => '', 'cn'=>'', 'jp' => '');
$zoom['config']['spinPreloaderSettings']['L2'] = array('en' => 'Making pyramid', 'de' => '', 'fr' => '', 'es' => '', 'it' => '', 'pt' => '', 'ru' => '', 'cn'=>'', 'jp' => '');
$zoom['config']['spinPreloaderSettings']['L3'] = array('en' => 'Making tiles', 'de' => '', 'fr' => '', 'es' => '', 'it' => '', 'pt' => '', 'ru' => '', 'cn'=>'', 'jp' => '');
$zoom['config']['spinPreloaderSettings']['L4'] = array('en' => 'Making first image', 'de' => '', 'fr' => '', 'es' => '', 'it' => '', 'pt' => '', 'ru' => '', 'cn'=>'', 'jp' => '');
$zoom['config']['spinPreloaderSettings']['L5'] = array('en' => 'and first image', 'de' => '', 'fr' => '', 'es' => '', 'it' => '', 'pt' => '', 'ru' => '', 'cn'=>'', 'jp' => '');
...
$zoom['config']['dragToSpin'] = array(
	...
	'file' => array('en' => 'drag_to_spin_en.png', 'de' => '', 'fr' => '', 'es' => '', 'it' => '', 'pt' => '', 'ru' => '', 'cn' => '', 'jp' => ''),
	'txt' => array(
...
$zoom['config']['spinNoInit'] = array(
	...
	'file' => array('en' => 'click_to_load_en.png', 'de' => '', 'fr' => '', 'es' => '', 'it' => '', 'pt' => '', 'ru' => '', 'cn' => '', 'jp' => ''),
	'txt' => array(
...
// Disable "forceToPan" when the user chooses a different tool when "forceToPan" is enabled
...
// Enable a different icon when mouse is down on the regular navigation button.
$zoom['config']['naviDownState'] = true;

// Enable a different icon when mouse is over the regular navigation button.
...
$zoom['config']['zoomLogLevel'] = array('en' => 'Zoom Level', 'de' => '', 'fr' => '', 'es' => '', 'it' => '', 'pt' => '', 'ru' => '', 'cn'=>'', 'jp' => '');
$zoom['config']['zoomLogTime'] = array('en' => 'Zoom Time', 'de' => '', 'fr' => '', 'es' => '', 'it' => '', 'pt' => '', 'ru' => '', 'cn'=>'', 'jp' => '');
$zoom['config']['zoomLogTraffic'] = array('en' => 'Zoom Traffic', 'de' => '', 'fr' => '', 'es' => '', 'it' => '', 'pt' => '', 'ru' => '', 'cn'=>'', 'jp' => '');
$zoom['config']['zoomLogSeconds'] = array('en' => 'seconds', 'de' => '', 'fr' => '', 'es' => '', 'it' => '', 'pt' => '', 'ru' => '', 'cn'=>'', 'jp' => '');
$zoom['config']['zoomLogLoading'] = array('en' => 'Loading...', 'de' => '', 'fr' => '', 'es' => '', 'it' => '', 'pt' => '', 'ru' => '', 'cn'=>'', 'jp' => '');
...
$zoom['config']['helpTxt'] = '<div style="padding: 10px;"><h2 style="margin-top: 0">About: AJAX-ZOOM</h2><a href=http://www.ajax-zoom.com>AJAX-ZOOM</a> is a powerful jQuery based library for displaying high-resolution images and 360° / 3D spins.</div>'; // string
...
$zoom['config']['mapButTitle']['pan'] = array('en' => 'Pan tool', 'de' => '', 'fr' => '', 'es' => '', 'it' => '', 'pt' => '', 'ru' => '', 'cn'=>'', 'jp' => '');
$zoom['config']['mapButTitle']['crop'] = array('en' => 'Zoom rectangle tool', 'de' => '', 'fr' => '', 'es' => '', 'it' => '', 'pt' => '', 'ru' => '', 'cn'=>'', 'jp' => '');
$zoom['config']['mapButTitle']['spin'] = array('en' => 'Spin tool', 'de' => '', 'fr' => '', 'es' => '', 'it' => '', 'pt' => '', 'ru' => '', 'cn'=>'', 'jp' => '');

$zoom['config']['mapButTitle']['zoomIn'] = array('en' => 'Zoom in', 'de' => 'Vergößern', 'fr' => '', 'es' => '', 'it' => '', 'pt' => '', 'ru' => '', 'cn'=>'', 'jp' => '');
$zoom['config']['mapButTitle']['zoomOut'] = array('en' => 'Zoom out', 'de' => 'Verkleinern', 'fr' => '', 'es' => '', 'it' => '', 'pt' => '', 'ru' => '', 'cn'=>'', 'jp' => '');
$zoom['config']['mapButTitle']['zoomInBig'] = array('en' => 'Zoom in', 'de' => 'Vergößern', 'fr' => '', 'es' => '', 'it' => '', 'pt' => '', 'ru' => '', 'cn'=>'', 'jp' => '');
$zoom['config']['mapButTitle']['zoomOutBig'] = array('en' => 'Zoom out', 'de' => 'Verkleinern', 'fr' => '', 'es' => '', 'it' => '', 'pt' => '', 'ru' => '', 'cn'=>'', 'jp' => '');

$zoom['config']['mapButTitle']['moveTop'] = array('en' => 'Move up', 'de' => '', 'fr' => '', 'es' => '', 'it' => '', 'pt' => '', 'ru' => '', 'cn'=>'', 'jp' => '');
$zoom['config']['mapButTitle']['moveRight'] = array('en' => 'Move to the right', 'de' => '', 'fr' => '', 'es' => '', 'it' => '', 'pt' => '', 'ru' => '', 'cn'=>'', 'jp' => '');
$zoom['config']['mapButTitle']['moveBottom'] = array('en' => 'Move down', 'de' => '', 'fr' => '', 'es' => '', 'it' => '', 'pt' => '', 'ru' => '', 'cn'=>'', 'jp' => '');
$zoom['config']['mapButTitle']['moveLeft'] = array('en' => 'Move to the left', 'de' => '', 'fr' => '', 'es' => '', 'it' => '', 'pt' => '', 'ru' => '', 'cn'=>'', 'jp' => '');

$zoom['config']['mapButTitle']['reset'] = array('en' => 'Reset to initial size', 'de' => '', 'fr' => '', 'es' => '', 'it' => '', 'pt' => '', 'ru' => '', 'cn'=>'', 'jp' => '');

$zoom['config']['mapButTitle']['gallery'] = array('en' => 'Display gallery', 'de' => '', 'fr' => '', 'es' => '', 'it' => '', 'pt' => '', 'ru' => '', 'cn'=>'', 'jp' => '');
$zoom['config']['mapButTitle']['map'] = array('en' => 'Show / hide map', 'de' => '', 'fr' => '', 'es' => '', 'it' => '', 'pt' => '', 'ru' => '', 'cn'=>'', 'jp' => '');
$zoom['config']['mapButTitle']['close'] = array('en' => 'Close map', 'de' => '', 'fr' => '', 'es' => '', 'it' => '', 'pt' => '', 'ru' => '', 'cn'=>'', 'jp' => '');
$zoom['config']['mapButTitle']['help'] = array('en' => 'Help', 'de' => '', 'fr' => '', 'es' => '', 'it' => '', 'pt' => '', 'ru' => '', 'cn'=>'', 'jp' => '');

$zoom['config']['mapButTitle']['next'] = array('en' => 'Next image', 'de' => '', 'fr' => '', 'es' => '', 'it' => '', 'pt' => '', 'ru' => '', 'cn'=>'', 'jp' => '');
$zoom['config']['mapButTitle']['prev'] = array('en' => 'Previous image', 'de' => '', 'fr' => '', 'es' => '', 'it' => '', 'pt' => '', 'ru' => '', 'cn'=>'', 'jp' => '');
$zoom['config']['mapButTitle']['play'] = array('en' => 'Start diashow', 'de' => '', 'fr' => '', 'es' => '', 'it' => '', 'pt' => '', 'ru' => '', 'cn'=>'', 'jp' => '');
$zoom['config']['mapButTitle']['pause'] = array('en' => 'Stop diashow', 'de' => '', 'fr' => '', 'es' => '', 'it' => '', 'pt' => '', 'ru' => '', 'cn'=>'', 'jp' => '');

$zoom['config']['mapButTitle']['spinPlay'] = array('en' => 'Start spin', 'de' => '', 'fr' => '', 'es' => '', 'it' => '', 'pt' => '', 'ru' => '', 'cn'=>'', 'jp' => '');
$zoom['config']['mapButTitle']['spinPause'] = array('en' => 'Stop spin', 'de' => '', 'fr' => '', 'es' => '', 'it' => '', 'pt' => '', 'ru' => '', 'cn'=>'', 'jp' => '');

$zoom['config']['mapButTitle']['arrowLeft'] = array('en' => '', 'de' => '', 'fr' => '', 'es' => '', 'it' => '', 'pt' => '', 'ru' => '', 'cn'=>'', 'jp' => '');
$zoom['config']['mapButTitle']['arrowRight'] = array('en' => '', 'de' => '', 'fr' => '', 'es' => '', 'it' => '', 'pt' => '', 'ru' => '', 'cn'=>'', 'jp' => '');

$zoom['config']['mapButTitle']['fullScreen'] = array('en' => 'Open in fullscreen mode', 'de' => '', 'fr' => '', 'es' => '', 'it' => '', 'pt' => '', 'ru' => '', 'cn'=>'', 'jp' => '');
$zoom['config']['mapButTitle']['fullScreenExit'] = array('en' => 'Exit fullscreen', 'de' => '', 'fr' => '', 'es' => '', 'it' => '', 'pt' => '', 'ru' => '', 'cn'=>'', 'jp' => '');

$zoom['config']['mapButTitle']['fullScreenCornerInit'] = array('en' => 'Open in fullscreen mode', 'de' => '', 'fr' => '', 'es' => '', 'it' => '', 'pt' => '', 'ru' => '', 'cn'=>'', 'jp' => '');
$zoom['config']['mapButTitle']['fullScreenCornerRestore'] = array('en' => 'Exit fullscreen', 'de' => '', 'fr' => '', 'es' => '', 'it' => '', 'pt' => '', 'ru' => '', 'cn'=>'', 'jp' => '');

$zoom['config']['mapButTitle']['download'] = array('en' => 'Download current image in full resolution', 'de' => '', 'fr' => '', 'es' => '', 'it' => '', 'pt' => '', 'ru' => '', 'cn'=>'', 'jp' => '');
$zoom['config']['mapButTitle']['hotspots'] = array('en' => 'Toggle hotspots', 'de' => '', 'fr' => '', 'es' => '', 'it' => '', 'pt' => '', 'ru' => '', 'cn'=>'', 'jp' => '');

$zoom['config']['mapButTitle']['slideNext'] = array('en' => 'Next image', 'de' => '', 'fr' => '', 'es' => '', 'it' => '', 'pt' => '', 'ru' => '', 'cn'=>'', 'jp' => '');
$zoom['config']['mapButTitle']['slidePrev'] = array('en' => 'Prev image', 'de' => '', 'fr' => '', 'es' => '', 'it' => '', 'pt' => '', 'ru' => '', 'cn'=>'', 'jp' => '');

$zoom['config']['mapButTitle']['slideNextSpin'] = array('en' => 'Spin right', 'de' => '', 'fr' => '', 'es' => '', 'it' => '', 'pt' => '', 'ru' => '', 'cn'=>'', 'jp' => '');
$zoom['config']['mapButTitle']['slidePrevSpin'] = array('en' => 'Spin left', 'de' => '', 'fr' => '', 'es' => '', 'it' => '', 'pt' => '', 'ru' => '', 'cn'=>'', 'jp' => '');

$zoom['config']['mapButTitle']['customBtn1'] = array('en' => 'Custom button1 title', 'de' => '', 'fr' => '', 'es' => '', 'it' => '', 'pt' => '', 'ru' => '', 'cn'=>'', 'jp' => '');
$zoom['config']['mapButTitle']['customBtn2'] = array('en' => 'Custom button2 title', 'de' => '', 'fr' => '', 'es' => '', 'it' => '', 'pt' => '', 'ru' => '', 'cn'=>'', 'jp' => '');
...
// e.g. axZm_zoomLoader or axZm_zoomLoader1 for png sprite
...
// Possible values - md5, char, flat (false)
...
// Settings for querying images by the applications
...
// Ver. 4.4.0+ old type of tiles positioning
$zoom['config']['pyrTilesPxMode'] = false;
...
$zoom['config']['fullScreenExitText'] = array('en' => 'Press ESC to exit full screen mode', 'de' => '', 'fr' => '', 'es' => '', 'it' => '', 'pt' => '', 'ru' => '', 'cn'=>'', 'jp' => '');
...
// Ver. 4.3.1+ Ellements like mNavi or zoom slider can be configured to hide if mouse is not over the player. This option determins the delay for hiding.
...
// If true /axZm/plugins/jquery.requestAnimationFrame.min.js will be loaded; requires jQuery Ver. 1.8+
...
if (isset($_GET['example']) || isset($_GET['previewPic']) || isset($_GET['azImg']) || isset($inludeCustomConfig) || isset($_GET['qq'])) {

	// Custom config options for examples
	if (file_exists(dirname(__FILE__).'/zoomConfigCustom.inc.php')) {
